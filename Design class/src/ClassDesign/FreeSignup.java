	...
	public static void main (String []args) throws InterruptedException {
		...
		driver.manage().window().maximize();
		 driver.get("https://user.dev.thedesignersclass.com/");
		  ...
		  driver.findElement(By.xpath("(//div[@class='new-signout-style__Wrapper-sc-21m3e5-9 bIAvPN']/input[@name='firstName'])[1]")).sendKeys("ramu");
		  ...
		  driver.findElement(By.xpath("/html/body/div[1]/div/body/div[2]/div/div/p/div/div/div/div[2]/div[2]/div[9]/div[2]/div[2]/div[2]/div/div/div[2]/div[2]/div[4]/div[3]")).click();
		  Thread.sleep(3000);
